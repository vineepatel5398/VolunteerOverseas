$(window).on("load",function() {
  ...
  if (scrollTop > $(".innernav").offset().top - $("header").innerHeight()) {
     $(".innernav").addClass("navbar-fixed")
  } else if (scrollTop <=$(".innernav").offset().top) {
     $(".innernav").removeClass("navbar-fixed").clearQueue()
  }
});
...
function stickynavbar(){
  "use strict";
    ...
    $(document).scroll(function() {
      ...
      if (scrollTop > y_pos - headerHeight) {
...
function viewphotsowlcarousel(){
  ...
  function syncPosition(el) {
    ...
    //if you set loop to right, you have to restore this next line
